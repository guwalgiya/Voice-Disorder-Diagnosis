...
def loadMFCCs(selected_combo, classes, dsp_package, data, work_on_augmented, snippet_dict):
    ...
    for combo in selected_combo:
        ...
        if work_on_augmented:
            MFCCs = [data_point[2] for data_point in data if (data_point[0] == cur_name)]
        else:
            MFCCs = [data_point[2] for data_point in data if (data_point[0] == cur_name and data_point[1] == "N0.0")]
