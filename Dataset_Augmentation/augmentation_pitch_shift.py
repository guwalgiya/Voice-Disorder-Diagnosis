...
def pitch_shifting(vocal_type, pitch_shift_tool, num_step):
    original_path = "C:\\Music Technology Master\\7100 - Master Project\\Dataset - KayPentax" + "\\" + vocal_type;
    ...
    output_path_preset   = "C:\\Music Technology Master\\7100 - Master Project\\Dataset - KayPentax" + "\\" + vocal_type + "_Pitch_Shifted"
...
# User Input
pitch_shift_tool = "C:\\Music Technology Master\\7100 - Master Project\\elastiqueProCl.exe";
fs = 25000
num_step = 4
