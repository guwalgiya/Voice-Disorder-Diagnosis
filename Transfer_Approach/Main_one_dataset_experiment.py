...
from   vggish_keras              import get_vggish_keras, myVGGish
...
for fold_index in range(num_folds):
    ...
    # ===============================================
    # Get VGGish structure
    empty_VGGish = get_vggish_keras()
    pretrained_VGGish = empty_VGGish.load_weights("vggish_weights.ckpt")
